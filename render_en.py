...
for name in pages:
    raw=f"{B}/rendus/_en-{name}.png"; out=f"{B}/rendus/en-{name}_1440.png"
    subprocess.run([CH,"--headless=new","--disable-gpu","--hide-scrollbars",f"--screenshot={raw}","--window-size=1440,9000","--virtual-time-budget=8000",f"file://{B}/www/en/{name}.html"],check=True,capture_output=True)
