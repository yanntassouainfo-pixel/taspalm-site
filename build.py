...
.photo{position:relative;border-radius:20px;overflow:hidden;height:620px;background:var(--creme2)}
...
.card{position:relative;background:var(--creme2);border-radius:20px;overflow:hidden;min-height:520px;display:flex;flex-direction:column;justify-content:flex-end}
...
.card{box-shadow:0 18px 42px -26px rgba(14,46,36,.5);transition:transform .5s cubic-bezier(.2,.7,.2,1),box-shadow .5s,opacity .5s}
.grille3 .card:hover,.produits .card:hover{transform:translateY(-10px);box-shadow:0 38px 64px -30px rgba(14,46,36,.62)}
.card:hover img{transform:scale(1.06)}
.grille3:hover .card:not(:hover),.etapes:hover .etape:not(:hover),.publics:hover .public:not(:hover){opacity:.68}
.grille3 .card,.etapes .etape,.publics .public{transition:transform .5s cubic-bezier(.2,.7,.2,1),box-shadow .5s,opacity .5s,border-color .5s,background .5s}
.etape .photo,.rangee .photo,.deux>.photo{box-shadow:0 18px 42px -28px rgba(14,46,36,.45);transition:box-shadow .5s}
.etapes .etape:hover{transform:translateY(-10px)}
.etape:hover .photo{box-shadow:0 38px 64px -30px rgba(14,46,36,.6)}
.etape:hover .photo>img,.rangee:hover .photo>img,.deux>.photo:hover>img{scale:1.06}
.rangee:hover .photo,.deux>.photo:hover{box-shadow:0 34px 60px -30px rgba(14,46,36,.55)}
.publics .public:hover{transform:translateY(-8px);background:rgba(244,239,228,.06);border-color:rgba(244,239,228,.45)}
.sombre .card,.encre .card,.sombre .etape .photo,.encre .etape .photo{box-shadow:0 20px 46px -26px rgba(0,0,0,.65)}
.sombre .card:hover,.encre .card:hover,.sombre .etape:hover .photo,.encre .etape:hover .photo{box-shadow:0 40px 70px -30px rgba(0,0,0,.75)}
@media (prefers-reduced-motion:reduce){.card,.etape,.public{transition:none}.grille3 .card:hover,.etapes .etape:hover,.publics .public:hover{transform:none}.etape:hover .photo>img,.rangee:hover .photo>img,.deux>.photo:hover>img{scale:1}}
...
.photo>img{transition:scale .9s cubic-bezier(.2,.7,.2,1)}
